import { useUIColor } from "../theme"
import { Theme } from "../types"
import { Editor } from "../types/zed"

export const editor = (t: Theme): Partial<Editor> => {
    const ui = useUIColor(t.ui)

    return {
        active_line_background: ui["editor.active_line"],
