        ...
        themes: vec![UserTheme {
            ...
            styles: UserThemeStylesRefinement {
                colors: ThemeColorsRefinement {
                    border: Some(rgba(0x191a21ff).into()),
                    border_variant: Some(rgba(0xbd93f9ff).into()),
                    border_focused: Some(rgba(0x6272a4ff).into()),
                    border_selected: Some(rgba(0x191a21ff).into()),
                    border_transparent: Some(rgba(0x191a21ff).into()),
                    border_disabled: Some(rgba(0x191a21ff).into()),
                    ...
                    element_background: Some(rgba(0x282a36ff).into()),
